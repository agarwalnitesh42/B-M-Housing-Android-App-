...
public class NewPropertyActivity extends Activity {
	...
	private static String url_new_property = "http://www.bmhousing.in/Estate_Conny/new_property.php";
	// JSON Node names
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inputNearbyplaces=(EditText)findViewById(R.id.nearbyplaces);
	...
	class CreateNewProduct extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			String Nearbyplaces = inputNearbyplaces.getText().toString();
			...
			params.add(new BasicNameValuePair("NearByPlaces", Nearbyplaces));
