...
public class CopyOfReadComments extends ListActivity {
	...
	// testing on Emulator:
	private static final String READ_COMMENTS_URL = "http://31.170.160.110/Estate_Conny/comments.php";
	...
	public void addComment(View v) {
		...
		Intent i = new Intent(CopyOfReadComments.this, ScreenActivity.class);
		startActivity(i);
		finish();
	}
	...
	private void updateList() {
		...
		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
				R.layout.single_post, new String[] { TAG_TITLE, TAG_MESSAGE,
						TAG_USERNAME, TAG_STATUS, TAG_IMG }, new int[] { R.id.title, R.id.message,
						R.id.username, R.id.state,R.id.imgView });
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CopyOfReadComments.this);
